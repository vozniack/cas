...
VALUES ('2fa62938-850f-4c8a-9c72-d4d1d868c75b', 'Manage documents', 'MANAGE_DOCUMENTS',
        'Document management privileges set', 0, '238a882e-f4e9-4107-920f-3bb2bb206b70', null),
       ...
       ('cc3a0de1-9ab6-4d65-a1db-b0389fdce955', 'Manage invoices', 'MANAGE_INVOICES',
        'Invoices management privileges set', 1, '238a882e-f4e9-4107-920f-3bb2bb206b70', null),
       ...
       ('36db82ba-d81f-489b-b700-8f5e000f2cb6', 'Print documents', 'PRINT_DOCUMENTS',
        'Printing different types of documents set', 0, '28e00094-259d-4516-a04e-ab5876e1e1dd', null),
...
INSERT INTO users (id, email, password, first_name, last_name, organization_id)
VALUES ('306d03dc-61cd-4e52-b2ac-d8a431e9ff46', 'mailbox@your-mailbox.com',
...
INSERT INTO privileges (id, name, code, description, index, organization_id, parent_id)
VALUES ('c73992de-b68a-40b6-80a8-0a06e37dabe5', 'Mailbox operations set', 'MAILBOX',
        'Mailbox operations privileges set', 0, 'd118dd75-b96b-42fd-9ba1-8117c740997a', null),
